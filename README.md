...
This will create platform-specific distributables (DMG for macOS, MSI for Windows, etc.) in the `out/make/` directory.
...
The build process automatically detects your platform and creates appropriate packages:
